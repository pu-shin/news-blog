  ...
  <section class="home">
    <div class="home__container">
      ...
      <div class="home__content content-home">
        <span class="content-home__label">Illustration</span>
        <h1 class="content-home__title">
          Japan House opens in mountainside to foster peak creativity.
        </h1>
        <p class="content-home__text">
        ...
        <span class="content-home__autor">by Reta Torphy</span>
      </div>
    </div>
  </section>
</template>
